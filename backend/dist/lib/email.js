...
async function sendBookingEmail(email, patientName, doctorName, date, time, receiptId) {
...
async function sendRescheduleEmail(email, patientName, doctorName, date, time) {
...
async function sendCancellationEmail(email, patientName, doctorName, date) {
